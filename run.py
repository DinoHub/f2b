...
flatten_dets, smol_indices, smol_coords = f2b.detect(biggie, classes=None, buffer_ratio=0.0)

biggie_show = biggie.copy()
draw.draw_biggie(biggie_show, flatten_dets, smol_coords, smol_indices)
